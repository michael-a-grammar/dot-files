...
ln -sf ~/dev/dot-files/bpytop/bpytop.conf ~/.config/bpytop/bpytop.conf
...
ln -sf ~/dev/dot-files/fish/fzf-base16-tomorrow-night.fish ~/.config/fish/fzf-base16-tomorrow-night.fish
